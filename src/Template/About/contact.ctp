    ...
    <div class="panel-body row ">
      <div class="col-md-12 col-12  text-center" style="background-color: white; top: 100px;">
          <div >
              ...
              <p class="text-center">
                  Owner: <a href =  "https://steamcommunity.com/groups/gamegifts" class="btn btn-primary">Legend</a>
              </p>
              <p class="text-center">
                  Head Admin: <a href =  "https://steamcommunity.com/groups/gamegifts" class="btn btn-primary">RandomCritz</a>
              </p>
              <p class="text-center">
